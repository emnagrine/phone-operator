            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
               // Get the first character of the string
                ...
                if (firstChar == '3'|| firstChar == '5') {
                   ...
                   _res.setText("Your phone operator is Orange");
                        ...
                        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                            ...
                            if (!(numtel.length() == 8 && numtel.matches("[0-9]+"))) {
                                new AlertDialog.Builder(ApplicationPage.this)
                                        .setTitle("Error")
                                        .setMessage("The phone number must be 8 digits ")
                    ...
                    _res.setText("Your phone operator is Ooredoo");
                    ...
                    _res.setText("Your phone operator Tunisie Telecome");
                    ...
                    _res.setText("Your phone operator is ...");
